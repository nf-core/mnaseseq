...
```bash
nextflow run nf-core/mnaseseq --input '*_R{1,2}.fastq.gz' -profile docker
```
...
* `docker`
  ...
  * Pulls software from Docker Hub: [`nfcore/mnaseseq`](https://hub.docker.com/r/nfcore/mnaseseq/)
* `singularity`
